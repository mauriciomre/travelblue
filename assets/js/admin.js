...
async function openPedidoModal(id) {
    ...
    // Items
    html +=
        '<div class="table-outer" style="margin-bottom:16px"><div class="table-scroll">' +
        '<table style="width:100%"><thead><tr><th>Código</th><th>Descripción</th><th>Cant.</th><th>Precio</th><th>Subtotal</th></tr></thead><tbody>';
...
function wooFormatCambios(cambios) {
    var ETIQUETAS = { regular_price: "Precio", sale_price: "Precio oferta", stock_status: "Stock", status: "Estado", global_unique_id: "EAN (WooCommerce)", meta_ean: "EAN (Google Shopping)" };
