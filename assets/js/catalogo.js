...
// ── Lightbox de foto de producto (grilla y lista) ──────────────────────────
...
function lbInitZoomHandlers() {
    ...
    img.addEventListener("pointerdown", function (e) {
        ...
        // Va en un try/catch: si por lo que sea falla, no tiene que tirar
        // abajo el resto de la lógica de seguimiento del pellizco.
...
function printNota() {
    ...
    var html = '<!DOCTYPE html><html lang="es"><head><meta charset="utf-8">' +
        ...
        '.header h1{font-size:16px;font-weight:900;letter-spacing:.5px;color:#262c63;margin:0}' +
        ...
        '.cat-title{font-size:12px;font-weight:900;background:#262c63;color:#fff;padding:3px 8px;margin:10px 0 0}' +
